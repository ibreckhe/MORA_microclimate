## Script to clean climate data downloaded from the global historical climatology network. Author: Ian Breckheimer 15
## December 2013
...
## Examines the data.
scatter.smooth(as.Date(tmax_dat$DATE), tmax_dat$TMAX, pch = 20, cex = 0.2, col = rgb(0.5, 0.5, 0.5, 0.1), main = "TMAX", lpars = list(col = "red"))
...
## Examines the data.  scatter.smooth(as.Date(prcp_dat$DATE),prcp_dat$PRCP,pch=20,cex=0.2,
